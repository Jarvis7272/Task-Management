...
<body>
	...
	<div class="buttons">
		...
		<button onclick="showForm('employeeForm')">
			<i class="fas fa-eye"></i> Employees
		</button>
	</div>
	<div class="table-container">
		...
		<table>
			...
			List<taskManager> taskManager = tasks.getAllTask(employee_id);
	...
	<div id="employeeForm" class="form-container">
		<div class="form-content">
			<button class="close-btn" onclick="closeForm('employeeForm')">&times;</button>
			<div class="table-container">
